...
import portfolio from "../public/images/works/portfolio_home.png"; // Ensure this import
...
const passionProjects = [
  {
    ...
    title: "Proproo",
    thumbnail: proproo,
    description: "A property management website, live at proproo.com.au",
    delay: 0.1,
  ...
  },
  {
    id: "portfolio",
    title: "Portfolio",
    thumbnail: portfolio, // Ensure this reference
    description:
  ...
  },
  {
    ...
    description: "A tool for property investors or buyers to find the best suburbs to invest in",
    delay: 0.1,
    backgroundColor: "white",
    padding: "1rem",
  },
  {
    ...
    description: "A mobile application to allow users to have the ability to manage their money well in a single click.",
    delay: 0.1,
  },
  {
    id: "archery",
  ...
  },
  {
    ...
    description: "Coded a Mastermind game using ARM Assembly Language.",
    delay: 0.1,
  },
  {
    id: "dtphome",
    ...
    thumbnail: dtphome,
    description: "Explored the use of blockchain technology to create a decentralized trading platform for user transactions.",
    delay: 0.1,
  },
];
